...
learning_rate = 0.0006 # If you set this too high, it might explode. If too low, it might not learn
...
report_score(gold_label_dev,predictions,detailed=False)
predictions = []
...
report_score(gold_label_test,predictions,detailed=False)
